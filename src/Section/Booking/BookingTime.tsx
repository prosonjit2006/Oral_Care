              ...
              >
                {mergedDoctors.map((doctor) => {
                  const isActiveDoctor =
                    selectedDoctorId === null || doctor.id === selectedDoctorId;
                    ...
                    <SwiperSlide key={doctor.id}>
                      <Box
                        sx={{
                          ...
                          opacity: isActiveDoctor ? 1 : 0.3,
                          pointerEvents: isActiveDoctor ? "auto" : "none",
                          filter: isActiveDoctor ? "none" : "grayscale(50%)",
