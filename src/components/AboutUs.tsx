        ...
        <div className="relative flex flex-col items-center text-center mt-12 sm:mt-16 md:mt-20 lg:mt-24">
          ...
          <div className="absolute top-20 sm:top-24 md:top-28 lg:top-32">
            ...
            <div className="flex flex-col  sm:flex-row justify-center items-center gap-4 mt-6 md:mt-8">
              <button className="bg-blue-700 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full hover:bg-blue-800 transition text-sm sm:text-base">
                Book Appointment
              </button>

              <button className="border border-gray-400 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full hover:bg-gray-100 hover:border-zinc-600 transition text-sm sm:text-base">
                About Us
              </button>
            </div>
          </div>
